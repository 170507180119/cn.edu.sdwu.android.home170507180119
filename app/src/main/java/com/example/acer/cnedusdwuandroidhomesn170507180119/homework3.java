...
public class homework3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int[] answer=this.getResources().getIntArray(R.array.answer);
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                ...
                if (q < 3) {
                    ...
                    rb3.setText(list.get(q)[2]);
                    rb4.setText(list.get(q)[3]);
                    Log.i(homework3.this.toString(), String.valueOf(q));

                }
                if (q == 3) {
                    res += "用时共:" + total + "s"+"您答对了"+correct+"道题，"+"您答错了"+(3-correct)+"道题";
                    radioGroup.setVisibility(View.INVISIBLE);
                    Toast.makeText(homework3.this, res, Toast.LENGTH_SHORT).show();
