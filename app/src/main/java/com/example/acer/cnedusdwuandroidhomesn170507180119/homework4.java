    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //适配器指定应用自己定义的xml格式
                if(lists.isEmpty()){
                    SimpleAdapter sadapter = new SimpleAdapter(homework4.this, lists,R.layout.layout_homework_4_1, null, null);
                    ListView listView = (ListView) findViewById(R.id.pro_show);
                    listView.setAdapter(sadapter);
                }else{
                    SimpleAdapter sadapter = new SimpleAdapter(homework4.this, lists,R.layout.layout_homework_4_1, new String[]{"selname", "selkind", "img"}, new int[]{ R.id.produce_tv, R.id.pro_kind,R.id.produce_img});
                    ListView listView = (ListView) findViewById(R.id.pro_show);
                    listView.setAdapter(sadapter);
                }
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                lists.add(map);
                SimpleAdapter sadapter = new SimpleAdapter(homework4.this, lists,R.layout.layout_homework_4_1, new String[]{"proname", "prokind", "pmovie"}, new int[]{ R.id.produce_tv, R.id.pro_kind,R.id.produce_img});
                ListView listView = (ListView) findViewById(R.id.pro_show);
                listView.setAdapter(sadapter);
            }
